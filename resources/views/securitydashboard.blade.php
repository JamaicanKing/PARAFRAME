<x-app-layout>
        ...
        <div id="topleft" class="p-5 mx-4 col-md-6 bg-black opacity-90 overflow-hidden shadow sm:rounded-lg">
            ...
            <form autocomplete="off" name="submitInfo" id="submitInfo" actions="" onsubmit="FillInfo()" method="GET">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <label style="color:yellow">{{ __('VISITOR TYPE :') }}</label>
                    ...
                    <center class="col-md-6"><input type="submit" onclick="FillInfo();return true"
                            class="btn btn-success" value="SEARCH" /></center>
    ...
    <script>
        ...
        function FillInfo() {
            document.forms['submitInfo'].action = "{{ route('dashboard') }}";
