                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 order-lg-2">
                        <div class="card-profile-image">
                            <form method="POST" action="{{ route('residentDetails.update',['residentDetail' => $residentDetails[0]->id] ) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="image-upload">

                                    <img src="data:image;base64, {{ base64_encode($avatar[0]->avatar) }}" alt="Image"  />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" name="security_question_1" id="security_question_1" class="form-control form-control-alternative" placeholder="Security Question 1" value="{{ $residentDetails[0]->security_question_1 }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="input-country">Security Question 1 answer</label>
                                    <input type="text" name="security_answer_1" id="security_answer_1" class="form-control form-control-alternative" placeholder="Security answer 1" value="{{ $residentDetails[0]->security_answer_1 }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" name="security_question_2" id="security_question_2" class="form-control form-control-alternative" placeholder="Security Question 2" value="{{ $residentDetails[0]->security_question_2 }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="input-country">Security Question 2 answer</label>
                                    <input type="text" name="security_answer_2" id="security_answer_2" class="form-control form-control-alternative" placeholder="Security answer 2" value="{{ $residentDetails[0]->security_answer_2 }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" name="security_question_3" id="security_question_3" class="form-control form-control-alternative" placeholder="Security Question 3" value="{{ $residentDetails[0]->security_question_3 }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="input-country">Security Question 3 answer</label>
                                    <input type="text" name="security_answer_3" id="security_answer_2" class="form-control form-control-alternative" placeholder="Security answer 3" value="{{ $residentDetails[0]->security_answer_3 }}">
                                </div>
                            </div>
                            <div class="mt-4">
