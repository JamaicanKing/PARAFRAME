...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-yellow-400 leading-tight">
            <center><b>{{ __('RESIDENT EXIT') }}</b></center>
        </h2>
...
<!--VEHICLE COLOR -->
                    ...
                    <input onfocus="this.value=''" class="form-control" type="text" style="text-align:left;" name="entry_id" id="entry_id" placeholder="Entry ID" value="">
                    <BR>
            ...
            <?php 
                ...
                foreach ($resident as $resident) {
                    echo  '<img src="data:image;base64,' . base64_encode($resident->avatar) . '" alt="Image"  />';
                }
