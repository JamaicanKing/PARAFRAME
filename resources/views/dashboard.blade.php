  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        ...
        <p class="mb-0">Hello {{Auth::user()->name}}, welcome to your awesome dashboard!</p>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
            <i style='font-size:24px' class='fas text-center bg-primary rounded-circle'>&#xf505;</i>
            <div class="ms-3">
              <div class="d-flex align-items-center">
                <h3 class="mb-0">0</h3> <span class="d-block ms-2">Officers On Duty</span>
              </div>
        ...
        <div class="col-lg-4">
          <div class="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
            <i class="fas fa-house-user text-center bg-danger rounded-circle"></i>
            <div class="ms-3">
              <div class="d-flex align-items-center">
                <h3 class="mb-0">0</h3> <span class="d-block ms-2">Communities OffLine</span>
              </div>
              <p class="fs-normal mb-0">Lorem ipsum dolor sit amet</p>
            </div>
          </div>
