...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-yellow-400 leading-tight">
            <center><b>{{ __('VISITOR EXIT') }}</b></center>
        </h2>
            ...
            <form autocomplete="off" name="submitInfo" id="submitInfo" actions="" onsubmit="FillInfo()" method="GET">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <input onfocus="this.value=''" class="form-control" type="text" style="text-align:left;"
                        name="visit_id" id="visit_id" placeholder="ID USER" value="{{ $visit[0]->visit_id }}">
                    <!-- VISITOR NAME -->
                    ...
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            ...
                            value="{{ $visit[0]->name_visitor }}"></p>
                    <!-- AUTHORISATION STATUS -->
                    <label style="color:yellow">AUTHORISATION STATUS:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="status_authorisation" id="status_authorisation"
                            placeholder="AUTHORISATION STATUS" value="{{ $visit[0]->status_authorisation }}"></p>
                    <!-- VISITORY TYPE -->
                    <label style="color:yellow">MODE OF TRANSPORTATION:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="visitor_type" id="visitor_type"
                            placeholder="MODE OF TRANSPORTATION" value="{{ $visit[0]->visitor_type }}"></p>
                    <!-- RESIDENT NAME -->
                    <label style="color:yellow">RESIDENT NAME:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="name_resident" id="name_resident"
                            placeholder="NAME OF RESIDENT" value="{{ $visit[0]->name}}"></p>
                    <!-- COMMUNITY NAME -->
                    <label style="color:yellow">COMMUNITY:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="community" id="community" placeholder="COMMUNITY" value="{{ $visit[0]->community }}">
                    </p>
                    <!-- LOT NUMBER -->
                    <label style="color:yellow">LOT NUMBER:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="lot" id="lot" placeholder="LOT NUMBER" value="{{ $visit[0]->lot }}"></p>
                    <!-- STREET ADDRESS-->
                    <label style="color:yellow">STREET / AVENUE:</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="address" id="address" placeholder="STREET/AVENUE" value="{{ $visit[0]->address }}">
                    </p>
                    <!-- LICENSE PLATE-->
                    <label style="color:yellow">LICENSE PLATE #</label>
                    <p class="form-group col-md-6"><input onfocus="this.value=''" class="form-control" type="text"
                            style="text-align:left;" name="license_plate" id="license_plate"
                            placeholder="LICENSE PLATE NUMBER" value="{{ $visit[0]->license_plate }}"></p>
                    ...
                    <input onfocus="this.value=''" class="form-control" type="text" style="text-align:left;"
                        name="entry_id" id="entry_id" placeholder="Entry ID" value="{{ $visit[0]->entry_id }}">
                    <BR>
    ...
    <script>/*
        function test() {
            ...
            function populateFields(row) {
                ...
                el('entry_id').value = row.cells[9].innerHTML
        ...
        function FillInfo() {
            document.forms['submitInfo'].action = "{{ route('exit') }}";
            document.forms['submitInfo'].submit();
        }

        function SubmitInfo() {
            document.forms['submitInfo'].action = "{{ route('exit/store') }}";
            document.forms['submitInfo'].submit();
        }*/
    </script>
